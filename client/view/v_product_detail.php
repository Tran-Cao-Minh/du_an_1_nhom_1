                ...
                <div class="form__product__variant__size">
                    ...
                    <div class="product__filter-content-size form__product__variant__bottom">
                        <label class="product__filter-item">
                            ...
                            <div class="product__filter-label-size" for="24"><span class="prodduct__size-name">24</span>
                            </div>
                        </label>
                        <label class="product__filter-item">
                            <input type="checkbox" id="25">
                            <div class="product__filter-label-size" for="25"><span class="prodduct__size-name">25</span>
                            </div>
                        </label>
                        <label class="product__filter-item">
                        ...
                        <label class="product__filter-item product__filter-label--disabled">
    ...
    <div class="prod__detail-comment">
        <div class="prod__detail-comment-form">
            <textarea placeholder="Nhập bình luận của bạn..."
                class="js-comment-input prod__detail-comment-input"></textarea>
