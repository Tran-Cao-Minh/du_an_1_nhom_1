document.addEventListener("DOMContentLoaded", function () {
    ...
    //Khi click nút trái
    let anhnho = document.querySelectorAll('.prod__detail-other li');
    // Truy xuất tất cả ảnh nhỏ
    chuyenslide = function () {
        //1.Lấy vị trí slide hiện tại
        let vitrislideht = 0;
        let slideht = document.querySelector('.prod__detail-large__image ul li.prod__detail-image-item--pop_up');
        var anhnhoht = document.querySelector('ul.prod__detail-other li.prod__detail-other-item--choosen');
