    ...
    <div class="product__filter-column">
      ...
      <div class="product__filter-content">
        ...
        <div class="product__filter-item">
          ...
          <label class="product__filter-label" for="balenciaga"><span class="filter-name">Balenciaga</span></label>
        </div>
      </div>
    </div>
    <!-- End filter column -->
    ...
    <div class="product__filter-column">
      ...
      <div class="product__filter-content product__filter-content-size">
        ...
        <label class="product__filter-item">
          ...
          <label class="product__filter-label-size" for="25"><span class="prodduct__size-name">25</span></label>
        </label>
        <label class="product__filter-item">
