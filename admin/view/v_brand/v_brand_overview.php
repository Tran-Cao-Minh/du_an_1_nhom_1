    ...
    <form class="filter-form__body">
      <div class="filter-form__form-group--first">
        ...
        <select name="filter_column" class="filter-form__select-input js-select-filter-column-input">
          <option value="BrandName" data-type="text" class="filter-form__select-option">
            Tên thương hiệu
          </option>
          <option value="PkBrand_Id" data-type="text" class="filter-form__select-option">
            Mã thương hiệu
          </option>
        </select>
      </div>
                  ...
                  <tr class="data-table__table-body-row">
                    ...
                    <td class="data-table__table-body-cell">
                      <form class="data-table__table-cell-btn-group">
                        <input type="hidden" name="object_id" value="'.$row['PkBrand_Id'].'">
                      ...
                      <a href="?view_name=update&object_id='.$row['PkBrand_Id'].'" class="data-table__view-detail-link">
